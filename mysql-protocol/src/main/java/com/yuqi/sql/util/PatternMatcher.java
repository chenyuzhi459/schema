...
public class PatternMatcher {
     ...
     *   <([{^=$!|]})?*+>
     */
    private static String convertMysqlPattern(String mysqlPattern) throws UnsupportedOperationException {
    ...
    private static void checkPermittedCharactor(char c) throws UnsupportedOperationException {
        if (FORBIDDEN_CHARS.contains(c)) {
            throw new UnsupportedOperationException("Forbidden charactor: '" + c + "'");
        }
    }
    ...
    public static PatternMatcher createMysqlPattern(String mysqlPattern, boolean caseSensitive)
        ...
        try {
            ...
            throw new UnsupportedOperationException("Bad pattern in SQL: " + e.getMessage());
        }
        return matcher;
    }
}
